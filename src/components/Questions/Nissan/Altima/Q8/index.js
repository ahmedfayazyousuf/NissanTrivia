        ...
        function handleSubmit(){
            if(bool === false){
                if(location.state.count === 2){
                    ...
                    navigate(`/AltimaQ${n}`,{state:{count:location.state.count + 1,qns:qn,score:location.state.score,car:location.state.car,id:location.state.id,time:location.state.time}})
                }
            }
                ...
                if(location.state.count === 2){
                    ...
                    navigate(`/AltimaQ${n}`,{state:{count:location.state.count + 1,qns:qn,score:location.state.score+1,car:location.state.car,id:location.state.id,time:location.state.time}})
                }
        ...
        <div style={{backgroundColor: 'white', height: '100vh', width: '100vw', overflowY: 'hidden'}}>
            ...
            <div className="slotparent"  style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems:'center', width: '100%', marginTop: '15px'}}>
                <div className="slotdiv" style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems:'center', width: '100%'}} id='slotparent'>
                    <button className="grab" id="option1" onClick={() => {Handleclick("option1")}} value="option1" style={{width:"160px", margin: '10px', border:'1px solid black', borderRadius: '20px', padding: '7px', color: 'black', backgroundColor: 'transparent', cursor: 'grab'}}>Intelligent Emergency Braking</button>
                    <button className="grab" id="option2" onClick={() => {Handleclick("option2")}} value="option2" style={{width:"160px", margin: '10px', border:'1px solid black', borderRadius: '20px', padding: '7px', color: 'black', backgroundColor: 'transparent', cursor: 'grab'}}>Intelligent Forward Radar</button>
                </div>

                <div className="slotdiv" style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems:'center', width: '100%'}}>
                    <button className="grab" id="option3" onClick={() => {Handleclick("option3")}} value="option3" style={{width:"160px", margin: '10px', border:'1px solid black', borderRadius: '20px', padding: '7px', color: 'black', backgroundColor: 'transparent', cursor: 'grab'}}>Intelligent Collision Control</button>
                    <button className="grab" id="option4" onClick={() => {Handleclick("option4")}} value="option4" style={{width:"160px", margin: '10px', border:'1px solid black', borderRadius: '20px', padding: '7px', color: 'black', backgroundColor: 'transparent', cursor: 'grab'}}>Intelligent Cabin Monitor</button>
                </div>
